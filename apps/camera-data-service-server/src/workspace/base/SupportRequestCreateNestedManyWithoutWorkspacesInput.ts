...
@InputType()
class SupportRequestCreateNestedManyWithoutWorkspacesInput {
...
export { SupportRequestCreateNestedManyWithoutWorkspacesInput as SupportRequestCreateNestedManyWithoutWorkspacesInput };
